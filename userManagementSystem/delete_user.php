<?php
 require_once ("delete_user_controller.php");
 require_once ("error_handling_view.php");
                    ...
                    <div class="card-body">
                        <form class=""  action="" method="post">
                            ...
                            <div class="input-group">
                                 <input type="text" class="form-control my-4 py-2 reg-username" name="id" >
                            ...
                            <div class="text-center mt-3">
                                <button type="submit" class="btn btn-primary btn-register">Delete User</button>
                            </div>
